...
public class RetaileConnectionAdapter extends ArrayAdapter<Connections> {

    private String Id;
    private Context con;
    private ProgressDialog progressDialog;
    public RetaileConnectionAdapter(@NonNull Context context, @NonNull List<Connections> connectionsList) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        convertView = LayoutInflater.from(getContext()).inflate(R.layout.connectedretailerscontent, parent, false);
        ...
        final TextView retailName = (TextView)convertView.findViewById(R.id.tvRetailerName);
        ...
        deleteBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                new AlertDialog.Builder(con)
                        ...
                        .setMessage("Do you really want to remove connection with "+retailName.getText().toString() +" ?")
                        .setIcon(android.R.drawable.ic_dialog_alert)
                        .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {

                            public void onClick(DialogInterface dialog, int whichButton) {
                                MyConnectionsActivity.connectedArrayList.remove(connections);
                                RetaileConnectionAdapter.this.notifyDataSetChanged();
                                    ...
                                    public void onComplete(@NonNull Task<Void> task) {
                                        ...
                                        dr2.removeValue().addOnCompleteListener(new OnCompleteListener<Void>() {
                                            ...
                                            public void onComplete(@NonNull Task<Void> task) {
                                                ...
                                                //  MyConnectionsActivity.connectionsArrayList.remove(connections);
                                                //RetaileConnectionAdapter.this.notifyDataSetChanged();
                                                //progressDialog.dismiss();
                                            }
                                        });
