...
public class NewRequestAdapter extends ArrayAdapter<Connections> {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        convertView = LayoutInflater.from(getContext()).inflate(R.layout.newrequests, parent, false);
        ...
        databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for(DataSnapshot ds: dataSnapshot.getChildren())
                {
                    ...
                    {
                        medicineName.setText(retailers.getRetailName());
                            ...
                            public void onComplete(@NonNull Task<Void> task) {
                                ...
                                dr2.setValue(connections).addOnCompleteListener(new OnCompleteListener<Void>() {
                                    ...
                                    public void onComplete(@NonNull Task<Void> task) {
                                        ...
                                        MyConnectionsActivity.connectedArrayList.add(connections);
                                        MyConnectionsActivity.retaileConnectionAdapter.notifyDataSetChanged();
