...
public class AcceptedOrdersActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView = (ListView)findViewById(R.id.lvRetailersListAccepted);
        user = FirebaseAuth.getInstance().getCurrentUser();
        retailersArrayList = new ArrayList<>();
        progressDialog = new ProgressDialog(AcceptedOrdersActivity.this);
        ...
        databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                AcceptedRetailerListAdapter newRequestAdapter = new AcceptedRetailerListAdapter(AcceptedOrdersActivity.this,retailersArrayList);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                Intent intent = new Intent(getApplicationContext(),AcceptedMedicineActivity.class);
