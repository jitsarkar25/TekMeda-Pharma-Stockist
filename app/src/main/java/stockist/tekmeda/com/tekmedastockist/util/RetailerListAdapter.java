...
public class RetailerListAdapter extends ArrayAdapter<Connections> {

    private String Id;
    private Context con;
    private ProgressDialog progressDialog;
    public RetailerListAdapter(@NonNull Context context, @NonNull List<Connections> connectionsList) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        convertView = LayoutInflater.from(getContext()).inflate(R.layout.retailerlistcontents, parent, false);
        ...
        final TextView retailName = (TextView)convertView.findViewById(R.id.tvRetailerListName);
