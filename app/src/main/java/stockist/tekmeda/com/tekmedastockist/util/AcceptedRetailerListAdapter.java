...
public class AcceptedRetailerListAdapter extends ArrayAdapter<Connections> {

    private String Id;
    private Context con;
    private ProgressDialog progressDialog;
    public AcceptedRetailerListAdapter(@NonNull Context context, @NonNull List<Connections> connectionsList) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        convertView = LayoutInflater.from(getContext()).inflate(R.layout.acceptedorderscontent, parent, false);
        ...
        final TextView retailName = (TextView)convertView.findViewById(R.id.tvRetailerListNameAccepted);
        final TextView retailAddress = (TextView)convertView.findViewById(R.id.tvStockistAreaAccepted);
